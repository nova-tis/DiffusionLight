...
CMD ["/bin/bash", "-c", "source $CONDA_DIR/etc/profile.d/conda.sh && conda activate diffusionlight && python -u podmodel.py &&  uvicorn data_crunch_api:app --host 0.0.0.0 --port 80"]
# CMD ["tail", "-f", "/dev/null"]
